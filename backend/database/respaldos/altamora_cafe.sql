...
--
-- Host: localhost    Database: altamora_cafe
-- ------------------------------------------------------
...
CREATE TABLE `cajas` (
  ...
  KEY `cajas_abierta_en_index` (`abierta_en`),
  CONSTRAINT `cajas_usuario_apertura_id_foreign` FOREIGN KEY (`usuario_apertura_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `cajas_usuario_cierre_id_foreign` FOREIGN KEY (`usuario_cierre_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
CREATE TABLE `detalle_pedidos` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `detalle_pedidos_pedido_id_producto_id_unique` (`pedido_id`,`producto_id`),
  ...
  CONSTRAINT `detalle_pedidos_producto_id_foreign` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE RESTRICT
...
CREATE TABLE `pagos` (
  ...
  `estado` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'aprobado',
  ...
  KEY `pagos_pagado_en_index` (`pagado_en`),
  CONSTRAINT `pagos_pedido_id_foreign` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `pagos_usuario_id_foreign` FOREIGN KEY (`usuario_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT
...
CREATE TABLE `pedidos` (
  ...
  `tipo_servicio` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'local',
  ...
  `cancelado_por_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `pedidos_tipo_servicio_index` (`tipo_servicio`),
  KEY `pedidos_pedido_en_index` (`pedido_en`),
  KEY `pedidos_cancelado_por_id_foreign` (`cancelado_por_id`),
  CONSTRAINT `pedidos_caja_id_foreign` FOREIGN KEY (`caja_id`) REFERENCES `cajas` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `pedidos_cancelado_por_id_foreign` FOREIGN KEY (`cancelado_por_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
--
-- Dumping routines for database 'altamora_cafe'
--
...
-- Dump completed on 2026-07-30 15:27:35
